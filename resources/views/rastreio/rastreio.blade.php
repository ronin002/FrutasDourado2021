                                ...
                                <div class="container layout-right-container">
                                    <div class="x-row">
                                        <div class="col-12 container text-center layout-text-title-container">
                                            <div class="x-row layout-text-title-row"><span class="x-text-subtitle mx-auto layout-text-title xbold"></span></div>
                                    ...
                                    <div class="x-row layout-content-form">
                                        <div class="col-12 px-0">
                                            <form action="../login/login.php" method="POST"><!--../login/login.php-->
                                                <div class="x-row">
                                                    <div class="col-12 px-0"><span class="x-text-label text-capitalize layout-text-label" for="rastreio">Código de Rastreio</span>
                                                        <div class="form-group layout-form-group form-group"><input type="text" id="rastreio" name="rastreio" value="" placeholder="" class="form-control layout-form-input text-lowercase inputStandard--rVbLh form-control" /></div>
                                                    </div>
                                                </div>
                                                
                                                <div class="x-row layout-btn-row">
                                                    <div class="col-12 px-0 text-center"><span id="btnRastreio" class="btn primary text-nowrap layout-fullsizable-btn btn btn-primary"><span class="x-text-button d-block layout-text-btn light">Rastrear</span></div>
                                                </div>
...
<script>
    ...
    $('#btnRastreio').on('click', function (e) {
        var sRastr = document.getElementById("rastreio").value;
        alert('www.frutasdourado.com.br/produtos/rastreio_page.php?rastreio='+sRastr);
        //let url = " route('rastreio_page', ':rastreio') "";
        //url = url.replace(':rastreio', sRastr);
        //location.href = url;
        //location.href = "../rastreio_page/rastreio_page.php?rastreio="+sRastr;

        
        $.ajax({
            url: '{!! route('rastreio_page', ['id' => user_id]) !!}',
            type: 'DELETE',
