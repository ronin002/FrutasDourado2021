        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="title has-text-grey">Atualizar Produtos</h3>
                        ...
                        <form action={{ route('produto.update', $produto->id)}}  method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group layout-form-group form-group">
                                        ...
                                        <input  placeholder="Código NCM" id="ncm" class="numbersOnly"  name="ncm" type="text"  value="{{$produto->NCM}}" >
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <img id="imgBuscaNCM" class="position-absolute" src="{{ url('/') }}/images/search.png" style="height:1.5rem;width:1.5rem;top:45%;right:10%;cursor:pointer;" />
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="autocomplete" style="width:400px;">
                                        ...
                                        <input type="text" class="form-control" id="descricao_ncm" name="descricao_ncm" value="{{$produto->NCM}}"  />
                                        <input type="hidden" id="id_ncm" name="id_ncm" value="{{$produto->NCM}}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-7">
                                    ...
                                    <input type="text" class="form-control" name="descricao" id="descricao" value="{{$descricao_ncm}}"/>
                                    {{-- //INSERIR_CLIENTE --}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" class="form-control" name="gtin" id="gtin" value="{{$produto->gtin}}">
                                </div>

                                <div class="form-group col-md-3">
                                    <label for="campo2">Tipo</label>
                                    <!-- <input type="text" class="form-control" name="customer['hood']"> -->
                                    <select class="form-control" id="tipo" name="tipo" placeholder="Tipo Produto" value="{{$produto->tipo}}">
                                ...
                                <div class="form-group col-md-2">
                                    <img id="imgBuscaAddTipo" class="position-absolute" src="{{ url('/') }}/images/plus.png" style="height:1.5rem;width:1.5rem;top:45%;" />
                                </div>
